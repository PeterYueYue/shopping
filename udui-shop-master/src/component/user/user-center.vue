...
<div id="user-center-box">
    ...
    <div class="uMenu">
        <ul class="clearfix">
            ...
            <li>
                <a href="http://chat16.live800.com/live800/chatClient/chatbox.jsp?companyID=521323&configID=73766&jid=2707589477">
                    <i class="myReward"></i>
                    <p>在线客服</p>
                </a>
            </li>
            <li>
                <router-link to="/youjuanCenter">
                    <i class="partner"></i>
                    <p>赚优券</p>
                </router-link>
            </li>
    ...
    <ul class="uSeeting">
        ...
        <li v-show="userInfo.userApplyShopState != 6">
            <router-link :to="userInfo.userApplyShopState == null ? '/shopApply' : '/shopApplyState' ">
                <i class="kd-ico"></i>
