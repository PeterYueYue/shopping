<style>
    ...
    .shop-list li .itemPrice .score {
        ...
        width: 0;
        height: 0.24rem;
        background: url("http://fstatic.udui.com/static/images/score.png") 0 -0.46rem no-repeat;
...
<template>
    <div id="shop-list-box">
        <ul class="shop-list" v-infinite-scroll="loadMore" infinite-scroll-disabled="busy"
            ...
            <li class="clearfix" v-for="data in shopList">
                <router-link :to="'/shopInfo/sid/'+data.id">
                    ...
                    <div class="itemName" v-html="data.name"></div>
                    <div class="itemPrice">
                        <p class="score" style="width:1.4rem"></p>
                        <p class="scorebg"></p>
                    </div>
                    <div class="itemAddr clearfix">
                        <div class="fl">{{data.address}}</div>
                    </div>
