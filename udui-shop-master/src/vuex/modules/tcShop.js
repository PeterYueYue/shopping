...
const mutations = {
    ...
    [types.Set_pro_list](state, amount){
        state.tcProList = amount;
        state.shopListLoading = false;
    },
    ...
    [types.Set_shop_info] (state, amount){
        state.tcshopCollect = amount.isCollected;
        state.shopInfo = amount;
    },
    [types.Set_shop_product] (state, amount){
        state.shopProList = amount;
    },
    [types.Set_hot_shop_product] (state, amount){
        state.hotShopProList = amount;
    },
    [types.Set_tcshop_collect] (state, amount){
        state.tcshopCollect = amount;
    },
    [types.Set_tc_product_Info] (state, amount){
        state.tcshopProductInfo = amount;
    },
    [types.Set_tc_product_detailHtml] (state, amount){
        state.tcProductDetailHtml = amount;
    },
    [types.Set_tc_pro_isCollected] (state, amount){
        state.tcProIsCollected = amount;
    },
    [types.Set_tcCate_submenu](state,amount){
        state.subTcCateMenuData = amount
    },
}
